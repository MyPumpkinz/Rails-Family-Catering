class OrdersController < ApplicationController
  ...
  before_action :set_menus_array, only: %i[edit update new create]
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:order_date, :total_price, :status, :customer_id, orderdetails_attributes: [:menu_id, :quantity, :_destroy])
    end
